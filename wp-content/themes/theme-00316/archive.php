...
<h1>
<?php if ( is_day() ) : ?>
<?php printf( __( 'Daily Archives: %s', 'theme--00316' ), '<span>' . get_the_date() . '</span>' ); ?>
<?php elseif ( is_month() ) : ?>
<?php printf( __( 'Monthly Archives: %s', 'theme--00316' ), '<span>' . get_the_date( 'F Y' ) . '</span>' ); ?>
<?php elseif ( is_year() ) : ?>
<?php printf( __( 'Yearly Archives: %s', 'theme--00316' ), '<span>' . get_the_date( 'Y' ) . '</span>' ); ?>
<?php else : ?>
<?php _e( 'Blog Archives', 'theme--00316' ); ?>
<?php endif; ?>
</h1>
